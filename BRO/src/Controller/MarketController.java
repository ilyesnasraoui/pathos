...
public class MarketController implements Initializable {
    ...
    private void setChosenMovie(Movie movie) {
        ...
        System.out.println(movie.getLang());
        ...
        System.out.println("hethi ldate chosen"+movie.getDate());
...
//        chosenFilmCard.setStyle("-fx-background-color: #d64161 ;\n"
    ...
    private void addMovie(ActionEvent event) throws IOException {
        try {  //(int idFilm, int duree, int idCat, String nom, String lang, String imgUrl, String desc) 
            ...
            String arrOfStr = tfCat.getValue().split("-", 2)[0];            //Movie(idFilm, duree, idCat, nom, desc, image, desc,utube,date,rated);
            Movie m = new Movie(0, Integer.parseInt(tfRuntime.getText()), Integer.parseInt(arrOfStr), tfName.getText(), tfLang.getText(), urlInserted, tfDesc.getText(),tflink.getText(),tfdate.getText(),Float.parseFloat(tfrated.getText()));
...
//(int idFilm, int duree, int idCat, String nom, String lang, String imgUrl, String desc) 
    ...
    private void updateMovie(ActionEvent event) throws SQLException, IOException {
        ...
        Movie m = new Movie(Integer.parseInt(tfIdFilm.getText()), Integer.parseInt(tfRuntime.getText()), Integer.parseInt(arrOfStr), tfName.getText(), tfLang.getText(), urlInserted, tfDesc.getText(),tflink.getText(),tfdate.getText(),Float.parseFloat(tfrated.getText()));
        ServiceMovie sm = new ServiceMovie();
