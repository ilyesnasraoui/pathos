...
public void setData(Planning p, MyListener myListener) throws SQLException {
        ...
        System.out.print(p.getId_salle()+"="+id.getText());
        roomname.setText(ssa.getSalleNameById(p.getId_salle()));
    ...
    @FXML
    private void reserve(ActionEvent event) throws SQLException {
        ServiceReservation sp= new ServiceReservation();
        ServiceUser su = new ServiceUser();
                   

        Reservation r = new Reservation(Integer.parseInt(id.getText()),su.getIdByUsername(u));
        sp.add(r);
         System.out.print(r);
